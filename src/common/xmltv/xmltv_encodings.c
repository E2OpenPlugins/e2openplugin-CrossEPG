...
/* code took from libxml2 encoding.c */
...
void
xmltv_encodings_init (void) {
	xmlAddEncodingAlias ("ISO-8859-1", "latin-1");
    xmlNewCharEncodingHandler ("ISO-8859-2", ISO8859_2ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-3", ISO8859_3ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-4", ISO8859_4ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-5", ISO8859_5ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-6", ISO8859_6ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-7", ISO8859_7ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-8", ISO8859_8ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-9", ISO8859_9ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-10", ISO8859_10ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-11", ISO8859_11ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-13", ISO8859_13ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-14", ISO8859_14ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-15", ISO8859_15ToUTF8, NULL);
    xmlNewCharEncodingHandler ("ISO-8859-16", ISO8859_16ToUTF8, NULL);
}
