...
bool colors_read ()
{
	...
	/* init default colors */
	COLOR_WINDOW_TOP_RED_TAB = 0xffff0000;
	COLOR_WINDOW_TOP_GREEN_TAB = 0xff00ff00;
	COLOR_WINDOW_TOP_YELLOW_TAB = 0xfffffc00;
	COLOR_WINDOW_TOP_BLUE_TAB = 0xff0090ff;
	COLOR_WINDOW_TOP_CLOCK = 0xffffffff;
	COLOR_WINDOW_BOTTOM_TEXT = 0xffffffff;
	COLOR_WINDOW_BACKGROUND = 0xff03123e;
	
	COLOR_GRID_HEADERS_FOREGROUND = 0xffffffff;
	COLOR_GRID_HEADERS_BACKGROUND = 0xffff00ff;
	COLOR_GRID_TITLES_FOREGROUND = 0xffffffff;
	COLOR_GRID_TITLES_BACKGROUND = 0x00ff00ff;
	COLOR_GRID_TITLES_SELECTED_FOREGROUND = 0xff4f3e20;
	COLOR_GRID_TITLES_SELECTED_BACKGROUND = 0xffc0c0c0;
	COLOR_GRID_TITLES_REC_FOREGROUND = 0xff575556;
	COLOR_GRID_TITLES_REC_BACKGROUND = 0xfff38484;
	COLOR_GRID_TITLES_ZAP_FOREGROUND = 0xff575556;
	COLOR_GRID_TITLES_ZAP_BACKGROUND = 0xff95c1ea;
	COLOR_GRID_CHANNELS_FOREGROUND = 0xffffffff;
	COLOR_GRID_CHANNELS_BACKGROUND = 0x00ff00ff;
	COLOR_GRID_CHANNELS_SELECTED_FOREGROUND = 0xff4f3e20;
	COLOR_GRID_CHANNELS_SELECTED_BACKGROUND = 0xffc0c0c0;
	COLOR_GRID_BORDER = 0xff9db9c8;
	
	COLOR_INFO_FOREGROUND = 0xffffffff;
	COLOR_INFO_BACKGROUND = 0x00ff00ff;
	
	COLOR_LIST_CHANNELS_FOREGROUND = 0xffffffff;
	COLOR_LIST_CHANNELS_BACKGROUND = 0x00ff00ff;
	COLOR_LIST_CHANNELS_SELECTED_FOREGROUND = 0xff333333;
	COLOR_LIST_CHANNELS_SELECTED_BACKGROUND = 0xffcccccc;
	
	COLOR_LIST_TITLES_FOREGROUND = 0xffffffff;
	COLOR_LIST_TITLES_BACKGROUND = 0x00ff00ff;
	COLOR_LIST_TITLES_SELECTED_FOREGROUND = 0xff333333;
	COLOR_LIST_TITLES_SELECTED_BACKGROUND = 0xffcccccc;
	COLOR_LIST_TITLES_REC_FOREGROUND = 0xffff0000;
	COLOR_LIST_TITLES_REC_BACKGROUND = 0x00ff00ff;
	COLOR_LIST_TITLES_ZAP_FOREGROUND = 0xff7777ff;
	COLOR_LIST_TITLES_ZAP_BACKGROUND = 0xff7777ff;
	
	COLOR_LIST_SCHEDULER_FOREGROUND = 0xffffffff;
	COLOR_LIST_SCHEDULER_BACKGROUND = 0x00ff00ff;
	COLOR_LIST_SCHEDULER_SELECTED_FOREGROUND = 0xff333333;
	COLOR_LIST_SCHEDULER_SELECTED_BACKGROUND = 0xffcccccc;
	
	COLOR_LIGHT_BACKGROUND = 0xffffffff;
	COLOR_LIGHT_FOREGROUND = 0x00ff00ff;
	COLOR_LIGHT_REC_FOREGROUND = 0xff333333;
	COLOR_LIGHT_ZAP_FOREGROUND = 0xffcccccc;
	COLOR_LIGHT_CHANNEL_FOREGROUND = 0xfffffe88;
	
	COLOR_PROGRESS_FOREGROUND = 0xffcccccc;
	COLOR_PROGRESS_BACKGROUND = 0xff03123e;
	COLOR_PROGRESS_BORDER = 0xffcccccc;
	
	COLOR_CONFIG_FOREGROUND = 0xffcccccc;
	COLOR_CONFIG_BACKGROUND = 0xff03123e;
	COLOR_CONFIG_BORDER = 0xffcccccc;
	COLOR_CONFIG_SELECTED_FOREGROUND = 0xff4f3e20;
	COLOR_CONFIG_SELECTED_BACKGROUND = 0xffcccccc;
	
	COLOR_MENU_FOREGROUND = 0xffffffff;
	COLOR_MENU_BACKGROUND = 0xff03123e;
	COLOR_MENU_BORDER = 0xffcccccc;
	COLOR_MENU_SELECTED_FOREGROUND = 0xff4f3e20;
	COLOR_MENU_SELECTED_BACKGROUND = 0xffcccccc;
	
	COLOR_BOX_FOREGROUND = 0xffcccccc;
	COLOR_BOX_BACKGROUND = 0xff03123e;
	COLOR_BOX_BORDER = 0xffcccccc;
	
	COLOR_PLUGINS_TOP_FOREGROUND = 0xffcccccc;
	COLOR_PLUGINS_TOP_BACKGROUND = 0xff03123e;
	COLOR_PLUGINS_BACKGROUND = 0xff03123e;
	COLOR_PLUGINS_BORDER = 0xffcccccc;
	COLOR_PLUGINS_RED = 0xffff0000;
	COLOR_PLUGINS_GREEN = 0xff00ff00;
	COLOR_PLUGINS_YELLOW = 0xfffffc00;
	COLOR_PLUGINS_BLUE = 0xff0090ff;
	...
	while (fgets (line, sizeof(line), fd)) 
	{
		...
		else if (strcmp (tmp_key, "light_zap_foreground") == 0) COLOR_LIGHT_ZAP_FOREGROUND = value;
		else if (strcmp (tmp_key, "light_rec_foreground") == 0) COLOR_LIGHT_REC_FOREGROUND = value;
